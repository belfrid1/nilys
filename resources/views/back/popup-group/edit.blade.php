                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="flex-row-fluid py-lg-5 px-lg-15">
                                <!--begin::Form-->
                                <form class="form" enctype='multipart/form-data' method="post" action="{{route('groups.update', $group->id)}}">
                                    @csrf
                                    <!--begin::Step 1-->
                                    <div class="current row" data-kt-stepper-element="content">
                                        <div class="col">
                                            ...
                                            <div class="fv-row  mb-10">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control" id="validationCustom01" name="guid" value="{{ old('guid') }}" placeholder="Guid" required>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
