                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="card-toolbar">
                            <a href="{{route('popup-groups.index')}}" class="btn btn-sm btn-light-primary">
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="flex-row-fluid py-lg-5 px-lg-15">
                                <!--begin::Form-->
                                <form class="form" enctype='multipart/form-data' id="" method="post" action="{{route('popup-groups.update', $group->id)}}">
                                    @csrf
                                    <!--begin::Step 1-->
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                                    ...
                                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify  unique Popup Group name"></i>
                                                </label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
